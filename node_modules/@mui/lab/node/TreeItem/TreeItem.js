...
const StyledTreeItemContent = (0, _styles.styled)(_TreeItemContent.default, {
  ...
  [`& .${_treeItemClasses.default.label}`]: {
    width: '100%',
...
const TreeItem = /*#__PURE__*/React.forwardRef(function TreeItem(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(TreeItemRoot, {
    ...
    onFocus: handleFocus,
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(StyledTreeItemContent, {
      as: ContentComponent,
      ref: contentRef,
      classes: {
      ...
      id: nodeId,
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(TreeItemGroup, {
